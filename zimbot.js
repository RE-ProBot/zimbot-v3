...
const timuu = moment.tz('Europe/Berlin').format('HH:mm:ss')
...
global.botdev = ['4915905842496','4915251332526']
global.bothelp = ['4915908158554']
...
if (db.data.chats[m.chat].antilink) {
    ...
    if (isCreator) return m.reply(`*whoa you are  bot creator i wont kick you*`)
...
break
	    ...
	    if (isBan) throw mess.ban
                ZimBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/e0f4b7b6789274812cc7c.jpg' }, caption: `*Hi Chomie ${m.pushName}*\n\n *Thanks for your support! ` }, { quoted: m })
            }
            break            
            case 'chat': {
                if (!isCreator) throw mess.owner
...
if (!isAdmins) throw mess.admin
if (args[0] === "on") {
if (db.data.chats[m.chat].antibule) return m.reply(`*Already on*`)
db.data.chats[m.chat].antibule = true
m.reply(`*Antilink active*`)
} else if (args[0] === "off") {
if (!db.data.chats[m.chat].antibule) return m.reply(`*Already off*`)
...
if (!isAdmins) throw mess.admin
if (args[0] === "on") {
if (db.data.chats[m.chat].antiwame) return m.reply(`*Already on*`)
db.data.chats[m.chat].antiwame = true
m.reply(`*Antilink active*`)
} else if (args[0] === "off") {
if (!db.data.chats[m.chat].antiwame) return m.reply(`*Already off*`)
...
let drips = [
  ...
  await ZimBotInc.sendButtonText(m.chat, drips, `*▊▊▊ANTILINK MODE▊▊▊*`, ZimBotInc.user.name, m)
         ...
         if (!isCreator) throw mess.owner
         if (args[0] === "on") {
         if (db.data.chats[m.chat].autoblock) return m.reply(`*Already on*`)
         db.data.chats[m.chat].autoblock = true
         m.reply(`*Autoblock active*`)
         } else if (args[0] === "off") {
         if (!db.data.chats[m.chat].autoblock) return m.reply(`*Already off*`)
...
let drips = [
  ...
  if (!isAdmins) throw mess.admin
  if (args[0] === "on") {
  if (db.data.chats[m.chat].antiinstagram) return m.reply(`*Already on*`)
  db.data.chats[m.chat].antiinstagram= true
  m.reply(`*Antilink active*`)
  } else if (args[0] === "off") {
  if (!db.data.chats[m.chat].antiinstagram) return m.reply(`*Already off*`)
  ...
  break
            ...
            case 'bcgc': case 'bcgroup': {
                if (!isCreator) throw mess.owner
                if (!text) throw `*Type some text*\n\nExample : ${prefix + command} SKY-BOT-INC`
          ...
          urlButton: {
                  displayText: 'GITHUB',
                  url: 'https://github.com/RE-ProBot'
          }
                            }]
...
case 'bcimage': case 'bcvideo': case 'bcaudio': {
                ...
                let anu = await store.chats.all().map(v => v.id)
                let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: fs.readFileSync('./lib/hisoka.jpg'), surface: 200, message: `SkͥyBͣoͫt`, orderTitle: '𝐒𝐤𝐲𝐁𝐨𝐭 𝐌𝐃', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
case 'bctext': {
                if (!isCreator) throw mess.owner
                if (!text) throw `*Type some text*\n\nExample : ${prefix + command} sky-bot`
...
case 'bcvid': case 'bcvideo': {
                ...
                let buf = `https://telegra.ph/file/61b585f92fd1ee5746b85.mp4`
             ...
             break
                ...
                //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                 ...
                 for (let i of anu) {
                     ...
                     teks += `⬡ *NAME :* ${metadata.subject}\n⬡ *OWNER :* @${metadata.owner.split('@')[0]}\n⬡ *ID :* ${metadata.id}\n⬡ *CREATED :* ${moment(metadata.creation * 1000).tz('Europe/Berlin').format('DD/MM/YYYY HH:mm:ss')}\n⬡ *MEMBER :* ${metadata.participants.length}\n\n━━━━━━━━━━━━━━━━━━━━━━━━\n\n`
                 }
                 ZimBotInc.sendTextWithMentions(m.chat, teks, m)
             }
             break
...
break
           ...
           await ZimBotInc.sendMedia(m.chat, `https://xteam.xyz/${command}?file&text=${text}`, 'ZIM', 'BOT M D', m, {asSticker: true})
...
url: 'https://www.youtube.com/channel/UCzM6SS7e2rQLJtMjbWclGnQ'
}
}, {
urlButton: {
displayText: 'GITHUB',
...
*Mime* : ${baby1[0].mime}
*Link* : ${baby1[0].link}\n
_whoa wait skybot processing..._
...
break
           ...
           // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)                       
            ...
            if (!args[0]) throw 'link github  EXAMPLE: https://github.com/RE-ProBot'
...
break
       ...
       // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                if (!text) throw `Example : ${prefix + command} sky bot-v95`
                if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            if (isLimit < 1) return m.reply(mess.endLimit)
            kurangLimit(m.sender, 1)
            m.reply(`*1 limit used*`)
...
ZimBotInc.sendMessage(m.chat, {image: {url: anu},viewOnce : true},{quoted: m })
        ...
        break
        case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'SkyBot': case 'a':const _0x12fbc6=_0xa830;function _0x5a3e(){const _0x1d2e27=['\x0a┃┃\x0a┃🏮𝗣𝗟𝗔𝗧𝗙𝗢𝗥𝗠\x20:\x20','ownername','Message','\x0a▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋\x0a▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋\x0a\x20+\x202\x207\x206\x20\x203\x20\x204\x20\x200\x20\x209\x20\x200\x202\x20\x200\x20\x203\x0a\x20','botname','\x0a\x0a╭▬▬❪\x20*Sky\x20BOT\x20EXE*❫▬▬▬\x0a┃🏮\x20*LIBRARY:*\x20Baileys-md\x0a┃┃\x0a┃🏮𝗕𝗢𝗧𝗡𝗔𝗠𝗘:\x20','1195460RyNtVa','\x0a┃┃\x0a┃🏮𝗢𝗪𝗡𝗘𝗥𝗡𝗔𝗠𝗘:\x20','LIST','key','6523785MZSaHJ','SKY\x20BOT\x20IS\x20ALIVE','5878536uJnrmT','\x0a⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯\x0a\x0a*SKYBOT\x20V1.5.9\x20WELCOMES\x20YOU*\x20','imageMessage','OWNER','owner','waUploadToServer','467946xkzyQz','uptime','2369958VHTLog','377875gbZphs','platform','ping','listmenu','chat','184vBAXES','SPEED','https://github.com/RE-ProBot','\x0a┃┃\x0a┃🏮𝗡𝗨𝗠𝗕𝗘𝗥:\x20','SUBSCRIBE','3595404noXmcO','GITHUB','relayMessage'];_0x5a3e=function(){return _0x1d2e27;};return _0x5a3e();}(function(_0x2241bd,_0x3fade8){const _0x5e1c6a=_0xa830,_0x587e66=_0x2241bd();while(!![]){try{const _0x19d1c9=parseInt(_0x5e1c6a(0x1aa))/0x1+parseInt(_0x5e1c6a(0x1a9))/0x2+-parseInt(_0x5e1c6a(0x1a7))/0x3+parseInt(_0x5e1c6a(0x1b4))/0x4+parseInt(_0x5e1c6a(0x19f))/0x5+parseInt(_0x5e1c6a(0x1a1))/0x6+parseInt(_0x5e1c6a(0x1bd))/0x7*(-parseInt(_0x5e1c6a(0x1af))/0x8);if(_0x19d1c9===_0x3fade8)break;else _0x587e66['push'](_0x587e66['shift']());}catch(_0x5934cf){_0x587e66['push'](_0x587e66['shift']());}}}(_0x5a3e,0xa1b18));function _0xa830(_0x4b8bc2,_0x133f6d){const _0x5a3e80=_0x5a3e();return _0xa830=function(_0xa83019,_0x49a73f){_0xa83019=_0xa83019-0x19f;let _0x58eca5=_0x5a3e80[_0xa83019];return _0x58eca5;},_0xa830(_0x4b8bc2,_0x133f6d);}{anu=_0x12fbc6(0x1a2)+pushname+_0x12fbc6(0x1bc)+global[_0x12fbc6(0x1bb)]+_0x12fbc6(0x1be)+global[_0x12fbc6(0x1b8)]+_0x12fbc6(0x1b2)+global[_0x12fbc6(0x1a5)]+_0x12fbc6(0x1b7)+os[_0x12fbc6(0x1ab)]()+'\x0a▙▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x0a🏮\x20*UPTIME:*\x20'+runtime(process[_0x12fbc6(0x1a8)]())+_0x12fbc6(0x1ba),drips=await getBuffer(picak+_0x12fbc6(0x1a0));let message=await prepareWAMessageMedia({'image':drips,'jpegThumbnail':drips},{'upload':ZimBotInc[_0x12fbc6(0x1a6)]});const template=generateWAMessageFromContent(m[_0x12fbc6(0x1ae)],proto[_0x12fbc6(0x1b9)]['fromObject']({'templateMessage':{'hydratedTemplate':{'imageMessage':message[_0x12fbc6(0x1a3)],'hydratedContentText':anu,'hydratedFooterText':''+global['botname'],'hydratedButtons':[{'urlButton':{'displayText':_0x12fbc6(0x1b3),'url':'https://www.skybot.link'}},{'urlButton':{'displayText':_0x12fbc6(0x1b5),'url':_0x12fbc6(0x1b1)}},{'quickReplyButton':{'displayText':_0x12fbc6(0x1b0),'id':_0x12fbc6(0x1ac)}},{'quickReplyButton':{'displayText':_0x12fbc6(0x1a4),'id':_0x12fbc6(0x1a5)}},{'quickReplyButton':{'displayText':_0x12fbc6(0x1bf),'id':_0x12fbc6(0x1ad)}}]}}}),{'userJid':m['chat'],'quoted':m});ZimBotInc[_0x12fbc6(0x1b6)](m[_0x12fbc6(0x1ae)],template['message'],{'messageId':template[_0x12fbc6(0x1c0)]['id']});}
...
┃ *✧ᴛɪᴍᴇ:* *${moment.tz('Europe/Berlin').format('HH:mm:ss')}*
┃ 
┃      ↣𝐘𝐨𝐮𝐭𝐮𝐛𝐞↢ 
┃https://skybot.link
┃
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://www.youtube.com/channel/UCzM6SS7e2rQLJtMjbWclGnQ` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/RE-ProBot` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
